...
<p class="decision-flow-desc">從確認收入到永久居留的完整決策流程</p>
</div>
<div class="decision-flow-branches">
<div class="decision-flow-branch-card">
<div class="branch-card-step">1</div>
<div class="branch-card-body">
<div class="branch-card-title">確認收入門檻</div>
<div class="branch-card-desc">月收入 ≥ USD 1,500 或 存款 ≥ USD 18,000</div>
</div>
</div>
<div class="decision-flow-branch-card">
<div class="branch-card-step">2</div>
<div class="branch-card-body">
<div class="branch-card-title">選擇申請途徑</div>
<div class="branch-card-desc">境外領事館（4~8 週）或 境內 MigranteWeb（10~15 天）</div>
</div>
</div>
<div class="decision-flow-branch-card">
<div class="branch-card-step">3</div>
<div class="branch-card-body">
<div class="branch-card-title">取得居留許可</div>
<div class="branch-card-desc">持簽證入境或境內轉換，錄入生物識別</div>
</div>
</div>
<div class="decision-flow-branch-card">
<div class="branch-card-step">4</div>
<div class="branch-card-body">
<div class="branch-card-title">⚠️ 稅務居民檢查</div>
<div class="branch-card-desc">12 個月內停留 ≥ 183 天 → 成為巴西稅務居民，全球所得申報 27.5%</div>
</div>
</div>
<div class="decision-flow-branch-card">
<div class="branch-card-step">5</div>
<div class="branch-card-body">
<div class="branch-card-title">續簽或離開</div>
<div class="branch-card-desc">滿 1 年可續簽 1 年，或離開巴西</div>
</div>
</div>
<div class="decision-flow-branch-card" style="border-color:var(--color-neon-green);">
<div class="branch-card-step" style="background:var(--color-neon-green);color:var(--color-bg);">6</div>
<div class="branch-card-body">
<div class="branch-card-title" style="color:var(--color-neon-green);">轉換為投資簽證 → 永久居留</div>
<div class="branch-card-desc">設立公司 + 注入資金 → SCE-IED 登記 → 4 年後申請永久居留</div>
</div>
</div>
</div>
</div>
